...
class TicketServiceImplTest {
    ...
    @Test
    void getAllTickets() {
        Ticket ticket1 = new Ticket(1L, "Title 1", "Description 1", LocalDateTime.now(), LocalDateTime.now().plusDays(1));
        Ticket ticket2 = new Ticket(2L, "Title 2", "Description 2", LocalDateTime.now(), LocalDateTime.now().plusDays(1));
    ...
    void getTicketById() {
        Long ticketId = 1L;
        Ticket ticket = new Ticket(ticketId, "Test Title", "Test Description", LocalDateTime.now(), LocalDateTime.now().plusDays(1));
...
//    @Test
//    void createTicket() {
//        Ticket inputTicket = new Ticket(null, "Test Title", "Test Description", null, null);
//        Ticket savedTicket = new Ticket(1L, "Test Title", "Test Description", LocalDateTime.now(), LocalDateTime.now().plusDays(1));
//
...
//    }
    ...
    void updateTicket() {
        Long ticketId = 1L;
        Ticket existingTicket = new Ticket(ticketId, "Existing Title", "Existing Description", LocalDateTime.now(), LocalDateTime.now().plusDays(1));
        Ticket updatedTicket = new Ticket(ticketId, "Updated Title", "Updated Description", LocalDateTime.now(), LocalDateTime.now().plusDays(1));
